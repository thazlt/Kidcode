 ...
 ?>
    ...
    <div class="container">
        <div class="row team-info">
            ...
            <form action="<?php echo URLROOT . "teacher/commitaddexercise";?>" method="post">
            <?php echo Form::token(); ?>
                  ...
                  <div class="single-post-content">
                    <div class="form-group">
                      <label for="Title">Exercise Title: </label>
                        <input type="text" id="title" class="text-field" placeholder="Your exercise title ..." name="ExerciseName" autocomplete="off" maxlength="200">
                        </div>
                        <label for="Title">Exercise details: </label>
                        <div class="single-post-content" style="padding: 0px 15px; margin-bottom: 0;">
                            <br>
                            <textarea name="ExerciseDescription" id="editor1" cols="60" rows="9" class="post-content" placeholder="Enter text here ..."></textarea>
                              <script>
